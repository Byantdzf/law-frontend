        ...
        columns: [
          {
            ...
            on: {
              click: ({ row, index }) => {
                const type = ['detail', 'adjust', 'logs'][index]
      ...
      async handleBtnAction(row, type) {
        ...
        switch (type) {
          ...
          case 'adjust':
            ...
            this.dialogTitle = '授信设置 - ' + row.tenantName
            this.dialogForm = row
            this.dialogComponent = 'Adjust'
            this.dialogVisible = true
            break;
          case 'logs':
          case 'orders':
      ...
      async formSubmit(form) {
        try {
          switch(this.dialogComponent) {
            case 'Adjust':
              await this.tenantCreditAdjust(form)
