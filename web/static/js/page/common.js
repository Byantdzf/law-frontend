layui.define(function (exports) {
	...
	var gahter = {
		...
		login: function (eb) {
			var html = '<div class="eqcodebox"><p>请用微信扫码登录，测试版，实际上会跳到微信的二维码页面<b class="layui-layer-close">X</b></p><img src="https://static.faniuwenda.com/pc/images/eqcode_240.png" width="244"></div><p style="text-align:center; margin-top:10px;" class="showTestCount">登录倒计时：3</p>';
		...
		eqService: function () {
			var html = '<div class="eqcodebox"><p style="font-size:18px;">客服电话：' + global.tel + '<b class="layui-layer-close" style=" font-size:12px;">X</b></p><img src="https://static.faniuwenda.com/pc/images/eqcode_240.png" width="244"><h4>扫码添加客服微信咨询</h4></div>';
